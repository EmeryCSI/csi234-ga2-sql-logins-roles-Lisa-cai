...
--Part3
-- 1, Create logins. Logins are created on the SERVER level in the master database
...
-- 4, Column-level permissions allow for more granular control over data access
